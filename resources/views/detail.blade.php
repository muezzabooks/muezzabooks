...
@section('content')-
    ...
    <div class="row align-items-center pb-5">
      ...
      <div class="col-lg-6 text-center pb-5">
          <img style="height: 100%; width: 200px" src="{{ $products->path }}" style="position: fixed"> 
      </div>
      ...
      <div class="col-lg-6">
        ...
        <div class="tab-content" id="nav-tabContent">
          <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            <p class="p-3">{{ $products->description }}</p></div>
          ...
          <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab" style=""><p class="p-3">Review is not available</p></div>
        </div>
